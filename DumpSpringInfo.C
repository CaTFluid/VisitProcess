...
// >> add 09/05/2013, consider single layer, such as interface-layer --> pts to spring distance
// family 0) radial springs
// family 1) circumferential springs
// family 2) axial springs
